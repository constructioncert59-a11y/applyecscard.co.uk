...
<head>
    ...
    <title>ECS Test · Fast‑Track UK Payment</title>
...
<!-- UK centric top bar -->
<div class="topbar">
    <span><i class="fas fa-flag-checkered"></i> ECS Partner</span>
    <span><i class="fas fa-lock"></i> FCA Regulated Payments</span>
    <span><i class="fas fa-phone-alt"></i> UK Support 7 days</span>
</div>
...
<header class="header">
    <div class="header-left">
        ...
        <div>
            <div class="header-title">ECS TEST</div>
            <div class="header-sub">UK Construction Skills Assessment</div>
        </div>
    </div>
...
<main class="page">
    ...
    <div class="page-head">
        <h1>ECS Test Payment<br><span style="font-size:1rem; font-weight:normal;">Fast‑track UK service</span></h1>
        <div class="badge-ref">
    ...
    <div class="layout">
        ...
        <div class="card">
            ...
            <h2>ECS Test – £59</h2>
            <p>All‑inclusive test registration + fast results.</p>
            <ul class="summary-list">
                <li><i class="fas fa-check-circle"></i> Official ECS health & safety test</li>
                <li><i class="fas fa-check-circle"></i> Instant booking confirmation</li>
                <li><i class="fas fa-check-circle"></i> Test centre locator included</li>
            </ul>
            <div class="order-meta">
                <span><i class="fas fa-hashtag"></i> Reference: <?php echo htmlspecialchars($reference); ?></span>
                <span><i class="fas fa-bolt"></i> Fast‑track booking</span>
                <span><i class="fas fa-calendar-alt"></i> Test Available</span>
            </div>
<div id="paypal-button-container"></div>
            <div class="price-box">
                <div class="price-main">£59.00 GBP</div>
            ...
            <div class="help-text">
                <i class="fas fa-shield-alt"></i> Your payment is processed by Wise or PayPal – we never see your card details. After payment you’ll receive a confirmation email with test details.
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="payment-buttons">
                <!-- Wise external link -->
                <a href="https://www.paypal.com/ncp/payment/VW8FFW27UN6CS" 
                   target="_blank" 
...
Cards, Apple Pay</small>
            ...
            <div class="payment-buttons">
                <!-- Wise external link -->
                <a href="https://wise.com/pay/r/Sja7coHKo38hsGY" 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   class="btn-wise"
                   onclick="trackWiseClick()">
            ...
            <div class="help-text" style="border-top:none; margin-top:0;">
                <i class="fas fa-comments"></i> Need help? <a href="#">Live chat</a> • <a href="mailto:booking@applyecscard.co.uk">Email</a> • <a href="#">FAQ</a>
    ...
    createOrder: function(data, actions) {
        return actions.order.create({
            purchase_units: [{
                ...
                description: 'ECS Test – Order <?php echo $reference; ?>'
            }],
            application_context: {
